window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const classMap = {
			...
			"fieldHint": "dshm_61pybv_fieldHint",
			"credentialInputRow": "dshm_61pybv_credentialInputRow",
			"secondaryButton": "dshm_61pybv_secondaryButton",
			"chipGroup": "dshm_61pybv_chipGroup",
			"chip": "dshm_61pybv_chip",
			"chipActive": "dshm_61pybv_chipActive",
			"chipBadge": "dshm_61pybv_chipBadge",
		...
		async function describeCredential(credentials, reference) {
			...
			return response.result.value.credentials[reference] ?? {
				configured: false,
				writable: true
			};
		}
