window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const classMap = {
			...
			"groupHeader": "dshm_o5Lh3q_groupHeader",
		...
		function DefaultsSection({ draft, setDraft, activeProvider, txtToAutoNotice, onDismissTxtNotice, t }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: classMap.groupHeader,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
							...
							children: t("action.resetSection")
						})]
					}),
		...
		function NumericInput({ className, value, min, max, step, disabled, placeholder, title, onChange }) {
		...
		function AdvancedSections({ draft, setDraft, t }) {
		...
		function SettingsPage({ rpc, credentials, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: t("action.resetDefaults")
							})
						]
					}),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderSection, {
						draft,
						setDraft,
						activeProvider,
						activeCredentialRef,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(DefaultsSection, {
						draft,
						setDraft,
						activeProvider,
						txtToAutoNotice,
