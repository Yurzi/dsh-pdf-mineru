window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:G:\hanako\dsh_plu\dsh-launcher\dsh-pdf-mineru\src\client\SettingsPage.module.css.mjs
		const css$1 = ".dshm_ywyYba_section{max-width:800px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:16px;padding-bottom:32px;display:flex}.dshm_ywyYba_title{color:var(--dsw-alias-label-primary);margin:0;font-size:18px;font-weight:600;line-height:26px}.dshm_ywyYba_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px;line-height:20px}.dshm_ywyYba_error{border:1px solid var(--dsw-alias-state-error-primary);background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:6px;justify-content:space-between;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;line-height:18px;display:flex}.dshm_ywyYba_errorDismiss{color:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0 4px;font-size:16px;line-height:1}.dshm_ywyYba_loading{color:var(--dsw-alias-label-tertiary);font-size:14px;line-height:22px}.dshm_ywyYba_editorGroup{border:0;border-top:1px solid var(--dsw-alias-border-l2);background:0 0;flex-direction:column;gap:12px;padding:16px 0 0;display:flex}.dshm_ywyYba_groupTitle{color:var(--dsw-alias-label-primary);border-bottom:1px solid var(--dsw-alias-border-l3);margin:0 0 4px;padding-bottom:6px;font-size:14px;font-weight:600;line-height:20px}.dshm_ywyYba_row{flex-wrap:wrap;gap:12px;display:flex}.dshm_ywyYba_row>.dshm_ywyYba_field{flex:220px}.dshm_ywyYba_field{flex-direction:column;gap:4px;min-width:0;display:flex}.dshm_ywyYba_checkboxField{cursor:pointer;user-select:none;align-items:center;gap:8px;display:flex}.dshm_ywyYba_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500;line-height:18px}.dshm_ywyYba_checkboxLabel{color:var(--dsw-alias-label-primary);font-size:13px;line-height:18px}.dshm_ywyYba_input,.dshm_ywyYba_select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);height:32px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);border-radius:6px;outline:none;padding:0 10px;font-size:13px;line-height:20px}.dshm_ywyYba_input:focus,.dshm_ywyYba_select:focus{border-color:var(--dsw-alias-brand-primary)}.dshm_ywyYba_input::placeholder{color:var(--dsw-alias-label-dimmed)}.dshm_ywyYba_input:disabled,.dshm_ywyYba_select:disabled{opacity:.6;cursor:default}.dshm_ywyYba_fieldHint{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px;line-height:16px}.dshm_ywyYba_credentialInputRow{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;display:grid}.dshm_ywyYba_credentialInputRow>.dshm_ywyYba_input{width:100%;min-width:0}@media (width<=520px){.dshm_ywyYba_credentialInputRow{grid-template-columns:minmax(0,1fr)}.dshm_ywyYba_credentialInputRow>.dshm_ywyYba_secondaryButton{justify-self:start}}.dshm_ywyYba_chipGroup{flex-wrap:wrap;gap:6px;margin-top:2px;display:flex}.dshm_ywyYba_chip{box-sizing:border-box;height:24px;font-size:11px;line-height:16px;font-family:var(--ds-font-family-code,monospace);border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);cursor:pointer;user-select:none;border-radius:4px;align-items:center;gap:4px;padding:0 8px;transition:background-color .15s,border-color .15s,color .15s;display:inline-flex}.dshm_ywyYba_chip:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-border-l3)}.dshm_ywyYba_chipActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-brand-primary);color:var(--dsw-alias-brand-primary);font-weight:500}.dshm_ywyYba_chipBadge{opacity:.85;font-family:system-ui,-apple-system,sans-serif;font-size:10px}.dshm_ywyYba_checkboxGroup{flex-wrap:wrap;gap:12px;margin-top:4px;display:flex}.dshm_ywyYba_checkboxOption{color:var(--dsw-alias-label-primary);cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.dshm_ywyYba_checkboxField input[type=checkbox],.dshm_ywyYba_checkboxOption input[type=checkbox]{cursor:pointer;accent-color:var(--dsw-alias-state-business-primary)}.dshm_ywyYba_actionBar{justify-content:flex-start;align-items:center;gap:12px;padding-top:8px;display:flex}.dshm_ywyYba_primaryButton{box-sizing:border-box;background:var(--dsw-alias-button-primary-fill);height:34px;color:var(--dsw-alias-label-primary-foreground);cursor:pointer;border:none;border-radius:6px;justify-content:center;align-items:center;padding:0 16px;font-size:13px;font-weight:500;transition:background-color .15s,opacity .15s;display:inline-flex}.dshm_ywyYba_primaryButton:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}.dshm_ywyYba_primaryButton:disabled{opacity:.4;cursor:not-allowed}.dshm_ywyYba_primaryButton:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3);outline:none}.dshm_ywyYba_secondaryButton{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);height:34px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:6px;justify-content:center;align-items:center;padding:0 14px;font-size:13px;font-weight:500;transition:background-color .15s,opacity .15s;display:inline-flex}.dshm_ywyYba_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-solid)}.dshm_ywyYba_secondaryButton:disabled{opacity:.4;cursor:not-allowed}.dshm_ywyYba_secondaryButton:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3);outline:none}.dshm_ywyYba_testResult{border-radius:6px;flex-direction:column;gap:4px;padding:10px 12px;font-size:12px;line-height:18px;display:flex}.dshm_ywyYba_testResultHealthy{background:var(--dsw-alias-state-success-tertiary);border:1px solid var(--dsw-alias-state-success-primary);color:var(--dsw-alias-state-success-primary)}.dshm_ywyYba_testResultError{background:var(--dsw-alias-interactive-bg-hover-danger);border:1px solid var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.dshm_ywyYba_testResultTesting{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary)}.dshm_ywyYba_testHeader{font-weight:600}.dshm_ywyYba_testDetails{font-family:var(--ds-font-family-code,monospace);color:var(--dsw-alias-label-secondary);font-size:11px}.dshm_ywyYba_operationToolbar{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.dshm_ywyYba_operationError{border-top:1px solid var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;padding:8px 0;font-size:12px;line-height:18px}.dshm_ywyYba_operationResult{border-top:1px solid var(--dsw-alias-border-l3);flex-direction:column;gap:8px;min-width:0;padding-top:10px;display:flex}.dshm_ywyYba_resultTitle{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:600;line-height:20px}.dshm_ywyYba_metricHeaders,.dshm_ywyYba_metric{grid-template-columns:minmax(120px,1fr) minmax(80px,auto) minmax(54px,auto);align-items:baseline;gap:10px;display:grid}.dshm_ywyYba_metricHeaders{color:var(--dsw-alias-label-tertiary);padding-bottom:4px;font-size:11px;line-height:16px}.dshm_ywyYba_metrics{gap:6px;margin:0;display:grid}.dshm_ywyYba_metric dt,.dshm_ywyYba_metric dd{min-width:0;margin:0;font-size:12px;line-height:18px}.dshm_ywyYba_metric dt{color:var(--dsw-alias-label-secondary)}.dshm_ywyYba_metric dd{color:var(--dsw-alias-label-primary);text-align:right;font-variant-numeric:tabular-nums}.dshm_ywyYba_summaryLine{color:var(--dsw-alias-label-secondary);flex-wrap:wrap;gap:6px 16px;font-size:12px;line-height:18px;display:flex}.dshm_ywyYba_tableWrap{width:100%;max-width:100%;overflow-x:auto}.dshm_ywyYba_operationTable{border-collapse:collapse;table-layout:fixed;width:100%;min-width:520px;font-size:11px;line-height:16px}.dshm_ywyYba_operationTable th,.dshm_ywyYba_operationTable td{border-bottom:1px solid var(--dsw-alias-border-l3);text-align:left;color:var(--dsw-alias-label-secondary);padding:6px 8px}.dshm_ywyYba_operationTable th:first-child,.dshm_ywyYba_operationTable td:first-child{width:28px;padding-left:0}.dshm_ywyYba_operationTable th:nth-child(3),.dshm_ywyYba_operationTable td:nth-child(3){width:80px}.dshm_ywyYba_operationTable th:nth-child(4),.dshm_ywyYba_operationTable td:nth-child(4){width:150px}.dshm_ywyYba_operationTable code{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,monospace);background:var(--dsw-alias-markdown-inline-code);border-radius:4px;padding:1px 4px;display:block;overflow:hidden}.dshm_ywyYba_dangerButton{box-sizing:border-box;border:1px solid var(--dsw-alias-state-error-primary);height:34px;color:var(--dsw-alias-state-error-primary);cursor:pointer;background:0 0;border-radius:6px;justify-content:center;align-items:center;padding:0 14px;font-size:13px;font-weight:500;transition:background-color .15s,opacity .15s;display:inline-flex}.dshm_ywyYba_dangerButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.dshm_ywyYba_dangerButton:disabled{opacity:.4;cursor:not-allowed}.dshm_ywyYba_dangerButton:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-state-error-primary);outline:none}@media (width<=520px){.dshm_ywyYba_row{flex-direction:column}.dshm_ywyYba_row>.dshm_ywyYba_field{flex:none;width:100%}.dshm_ywyYba_operationToolbar>button{flex:150px}.dshm_ywyYba_metricHeaders,.dshm_ywyYba_metric{grid-template-columns:minmax(0,1fr) auto auto}}";
		const classMap$1 = {
			"actionBar": "dshm_ywyYba_actionBar",
			"checkboxField": "dshm_ywyYba_checkboxField",
			"checkboxGroup": "dshm_ywyYba_checkboxGroup",
			"checkboxLabel": "dshm_ywyYba_checkboxLabel",
			"checkboxOption": "dshm_ywyYba_checkboxOption",
			"chip": "dshm_ywyYba_chip",
			"chipActive": "dshm_ywyYba_chipActive",
			"chipBadge": "dshm_ywyYba_chipBadge",
			"chipGroup": "dshm_ywyYba_chipGroup",
			"credentialInputRow": "dshm_ywyYba_credentialInputRow",
			"dangerButton": "dshm_ywyYba_dangerButton",
			"editorGroup": "dshm_ywyYba_editorGroup",
			"error": "dshm_ywyYba_error",
			"errorDismiss": "dshm_ywyYba_errorDismiss",
			"field": "dshm_ywyYba_field",
			"fieldHint": "dshm_ywyYba_fieldHint",
			"fieldLabel": "dshm_ywyYba_fieldLabel",
			"groupTitle": "dshm_ywyYba_groupTitle",
			"input": "dshm_ywyYba_input",
			"intro": "dshm_ywyYba_intro",
			"loading": "dshm_ywyYba_loading",
			"metric": "dshm_ywyYba_metric",
			"metricHeaders": "dshm_ywyYba_metricHeaders",
			"metrics": "dshm_ywyYba_metrics",
			"operationError": "dshm_ywyYba_operationError",
			"operationResult": "dshm_ywyYba_operationResult",
			"operationTable": "dshm_ywyYba_operationTable",
			"operationToolbar": "dshm_ywyYba_operationToolbar",
			"primaryButton": "dshm_ywyYba_primaryButton",
			"resultTitle": "dshm_ywyYba_resultTitle",
			"row": "dshm_ywyYba_row",
			"secondaryButton": "dshm_ywyYba_secondaryButton",
			"section": "dshm_ywyYba_section",
			"select": "dshm_ywyYba_select",
			"summaryLine": "dshm_ywyYba_summaryLine",
			"tableWrap": "dshm_ywyYba_tableWrap",
			"testDetails": "dshm_ywyYba_testDetails",
			"testHeader": "dshm_ywyYba_testHeader",
			"testResult": "dshm_ywyYba_testResult",
			"testResultError": "dshm_ywyYba_testResultError",
			"testResultHealthy": "dshm_ywyYba_testResultHealthy",
			"testResultTesting": "dshm_ywyYba_testResultTesting",
			"title": "dshm_ywyYba_title"
		};
		const tagId$1 = "dsh-pdf-mineru/SettingsPage.module.css";
		...
		function StorageOperations({ rpc, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: classMap$1.editorGroup,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
						className: classMap$1.groupTitle,
						children: t("section.operations")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: classMap$1.operationToolbar,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: classMap$1.secondaryButton,
								disabled: busy,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: confirmingCacheClear ? classMap$1.dangerButton : classMap$1.secondaryButton,
								disabled: busy,
					...
					state.error !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: classMap$1.operationError,
						children: state.error
					}),
					state.stats !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: classMap$1.operationResult,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: classMap$1.resultTitle,
								children: t("action.storageStats")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: classMap$1.metricHeaders,
								children: [
					...
					state.scan !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							className: classMap$1.summaryLine,
							children: [
					...
					state.quarantine !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							className: classMap$1.tableWrap,
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("table", {
								className: classMap$1.operationTable,
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								type: "button",
								className: confirmingDelete ? classMap$1.dangerButton : classMap$1.secondaryButton,
								disabled: busy || selected.length === 0,
		...
		function SettingsPage({ rpc, credentials, t, embedded = false }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					testState.status !== "idle" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: `${classMap$1.testResult} ${testState.status === "healthy" ? classMap$1.testResultHealthy : testState.status === "unhealthy" || testState.status === "error" ? classMap$1.testResultError : classMap$1.testResultTesting}`,
						children: [
							...
							testState.status === "error" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: classMap$1.testHeader,
							...
							(testState.status === "healthy" || testState.status === "unhealthy") && testState.view && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								className: classMap$1.testDetails,
								children: [
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
									className: classMap$1.field,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: classMap$1.fieldLabel,
										children: t("field.activeProvider")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
										className: classMap$1.select,
										...
										children: draft.providers.map((provider) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("option", {
											value: provider.id,
											children: [
												t(provider.type === "self-hosted-v2" ? "provider.type.selfHosted" : "provider.type.official"),
												" — ",
												provider.id
											]
										}, provider.id))
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: classMap$1.fieldHint,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: classMap$1.credentialInputRow,
							...
							activeProvider.type === "self-hosted-v2" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: classMap$1.row,
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
									className: classMap$1.checkboxField,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
										type: "checkbox",
										...
										className: classMap$1.checkboxLabel,
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											className: classMap$1.chipGroup,
											children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
												type: "button",
												className: `${classMap$1.chip} ${activeProvider.modelMap.pipeline === "pipeline" ? classMap$1.chipActive : ""}`,
												onClick: () => {
													const currentMap = activeProvider.modelMap;
													setDraft((prev) => prev === null ? prev : patchActiveProvider(prev, { modelMap: {
														...currentMap,
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "pipeline" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
													className: classMap$1.chipBadge,
													children: [
														"(",
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											...
											children: [{
												...
												type: "button",
												className: `${classMap$1.chip} ${activeProvider.modelMap.vlm === opt.value ? classMap$1.chipActive : ""}`,
												onClick: () => {
													const currentMap = activeProvider.modelMap;
													setDraft((prev) => prev === null ? prev : patchActiveProvider(prev, { modelMap: {
														...currentMap,
							...
							activeProvider.type === "official-v4" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									className: classMap$1.checkboxGroup,
									children: ["pipeline", "vlm"].map((m) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										className: classMap$1.checkboxOption,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											type: "checkbox",
		...
		//#endregion
		//#region \0dsh-css:G:\hanako\dsh_plu\dsh-launcher\dsh-pdf-mineru\src\client\SettingsCard.module.css.mjs
		const css = ".dshm_aCfVMa_card{min-width:0;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-3,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px}.dshm_aCfVMa_card:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.dshm_aCfVMa_header{cursor:pointer;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;list-style:none;display:flex}.dshm_aCfVMa_header::-webkit-details-marker{display:none}.dshm_aCfVMa_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.dshm_aCfVMa_heading{overflow-wrap:anywhere;flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.dshm_aCfVMa_title{font-size:14px;font-weight:600;line-height:20px}.dshm_aCfVMa_description{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.dshm_aCfVMa_chevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none}.dshm_aCfVMa_card[open]>.dshm_aCfVMa_header .dshm_aCfVMa_chevron{transform:rotate(180deg)}.dshm_aCfVMa_body{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-top:16px}";
		const classMap = {
			"body": "dshm_aCfVMa_body",
			"card": "dshm_aCfVMa_card",
			"chevron": "dshm_aCfVMa_chevron",
			"description": "dshm_aCfVMa_description",
			"header": "dshm_aCfVMa_header",
			"heading": "dshm_aCfVMa_heading",
			"title": "dshm_aCfVMa_title"
		};
		const tagId = "dsh-pdf-mineru/SettingsCard.module.css";
		if (typeof document !== "undefined") {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("summary", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						className: classMap.heading,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: classMap.title,
							children: props.t("page.title")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: classMap.description,
							children: props.t("card.description")
						})]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
						className: classMap.chevron,
						width: "16",
						height: "16",
						viewBox: "0 0 24 24",
						fill: "none",
		...
		function adaptLegacyCredentials(legacy) {
			return {
				async describe(refs) {
					...
					return result.ok ? {
						ok: true,
						value: result.value.credentials
					} : result;
				},
				async set(ref, value) {
					const { result } = await legacy.set({
						ref,
						value
					});
					return result.ok ? {
		...
		function registerSettings(ctx, connection, credentials) {
