...
function parseReadInput(args) {
	...
	if (obj.view === "page") {
		for (const key of [
			...
			"inline_images",
			"poll_timeout_ms"
		]) if (obj[key] !== void 0) throw new MinerUError(failure("INVALID_REQUEST", "page view accepts only file_path, pages, and optional expected_sha256"));
		let selected;
		try {
...
function registerTools(ctx, getService, accessGate, getOutputConfig = () => DEFAULT_OUTPUT_CONFIG) {
	const disposers = [];
